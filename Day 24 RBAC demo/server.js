...
// curl -H "username : alice" http://localhost:4000/read
// curl -H "username : bob" -X POST http://localhost:4000/write
// curl -H "username : charlie" -X DELETE http://localhost:4000/delete